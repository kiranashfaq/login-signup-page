...
// var category = []
var productsDiv = document.getElementById("container");
productsDiv.innerHTML = ""; // clear the previous content
for (let i = 0; i < products.length; i++) {
  //     var dropdown = document.getElementById("dropdown");
  ...
  //     // dropdown.innerHTML += `<option value="${products[i].category}">${products[i].category}</option>`;
  // }
  ...
  for (let j = 0; j < products[i].reviews.length; j++) {
    ...
    // cat.innerHTML = `products[i].category`;
    var card = document.createElement("div");
    card.className = "card"; // add a class to the card element
    ...
    card.innerHTML = `
            ...
            <div class="imgBx">
          <img src="./img/${products[i].title}.png" alt="" />
        </div>
              <div class="content">
...
for (let y = 0; y < category.length; y++) {
  if(!newCategory.includes(category[y]))
{
  newCategory.push(category[y]);
...
var dropdown_brand = document.getElementById("dropdown-brand");
dropdown.addEventListener("click",function () {
  dropdown_brand.innerHTML = `<option value="select brand" id="">Select Brand</option>`;
  var selectCategory = dropdown.value

console.log(selectCategory);
for (let p = 0; p < products.length; p++) {
    
 if(selectCategory === products[p].category)  {
  dropdown_brand.innerHTML += `<option value="${products[p].brand}">${products[p].brand}</option>`
...
dropdown_brand.addEventListener("change", function(){

document.body.style.backgroundColor = `black`;
  var selectBrand = dropdown_brand.value
  productsDiv.innerHTML = ""; 
  container_brand.innerHTML = ""
  for (let q = 0; q < products.length; q++) {
    // for (let k = 0; k < products[q].reviews.length; k++) {
    if (products[q].brand == selectBrand) {
      
   
  var card_brand = document.createElement("div")
  card_brand.className = "card-brand"; // add a class to the card element
  card_brand.innerHTML = `            <div class="imgBx-brand">
                <img src="./img/${products[q].title}.png" alt="">
            </div>
            <div class="contentBx">

                <h2>${products[q].title}</h2>

                <div class="siz">
                
                <h3 class="text-yellow">Price: <span class="price">${products[q].price}</span></h3>
                </div>
 <div class="colo">

                    <span class="text-yellow">discountPercentage: <span class="price"> ${products[q].discountPercentage}</span></span></br>
                    <span class="text-yellow">Brand Name:<span class="price"> ${products[q].brand}</span></span>
...
`;
  container_brand.appendChild(card_brand)
  }}}
// }
)
...
//   var selectValue = dropdown.value;
//   for (let i = 0; i < products.length; i++) {
//     if (products[i].category == selectValue) {
//       for (let j = 0; j < products[i].reviews.length; j++) {
//         var card = document.createElement("div");
//         card.className = "card"; // add a class to the card element
...
//             <div class="imgBx">
//           <img src="./src/img/${products[i].title}.png" alt="" />
//         </div>
//               <div class="content
// dropdown.innerHTML += `<option value="${newCategory[y]}">${newCategory[y]}</option>`;
